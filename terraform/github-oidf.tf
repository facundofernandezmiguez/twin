    ...
    Statement = [
      {
        ...
        Condition = {
          ...
          StringLike = {
            # GitHub includes numeric owner/repo IDs in sub for newer repos
            "token.actions.githubusercontent.com:sub" = "repo:facundofernandezmiguez@141341195/twin@1332135786:*"
          }
        }
      }
    ]
